...
CLIPS = (
    ...
    ClipSpec(
        ...
        False,
        (
            KeyPose(1, {"thigh.L": (radians(24), 0.0, 0.0), "thigh.R": (radians(-24), 0.0, 0.0), "upper_arm.L": (radians(-16), 0.0, 0.0), "upper_arm.R": (radians(16), 0.0, 0.0)}),
            KeyPose(7, {"thigh.L": (0.0, 0.0, 0.0), "thigh.R": (0.0, 0.0, 0.0), "shin.L": (radians(18), 0.0, 0.0), "shin.R": (radians(6), 0.0, 0.0)}),
            KeyPose(13, {"thigh.L": (radians(-24), 0.0, 0.0), "thigh.R": (radians(24), 0.0, 0.0), "upper_arm.L": (radians(16), 0.0, 0.0), "upper_arm.R": (radians(-16), 0.0, 0.0)}),
            KeyPose(19, {"thigh.L": (0.0, 0.0, 0.0), "thigh.R": (0.0, 0.0, 0.0), "shin.L": (radians(6), 0.0, 0.0), "shin.R": (radians(18), 0.0, 0.0)}),
            KeyPose(25, {"thigh.L": (radians(24), 0.0, 0.0), "thigh.R": (radians(-24), 0.0, 0.0), "upper_arm.L": (radians(-16), 0.0, 0.0), "upper_arm.R": (radians(16), 0.0, 0.0)}),
        ),
    ),
    ClipSpec(
        "wave",
        ...
        False,
        (
            KeyPose(1, {"shoulder.R": (0.0, 0.0, radians(12)), "upper_arm.R": (0.0, 0.0, radians(55)), "forearm.R": (radians(-80), 0.0, 0.0)}),
